...
public class AuthTokenProvider {
    ...
    public String createToken(Member member, String loginSessionKey) {
        String payload = PREFIX + member.getId() + DELIMITER + loginSessionKey;
    ...
    public record TokenPayload(Long memberId, String loginSessionKey) {
    }
}
