...
public class Member {
    ...
    public void renewLoginSession(String loginSessionKey) {
        validateNonBlank(loginSessionKey, "로그인 세션 키는 비어 있을 수 없습니다.");
        this.loginSessionKey = loginSessionKey;
    }

    public boolean hasLoginSession(String loginSessionKey) {
        return this.loginSessionKey != null && this.loginSessionKey.equals(loginSessionKey);
    }
