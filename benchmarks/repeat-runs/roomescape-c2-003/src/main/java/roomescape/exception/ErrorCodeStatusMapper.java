...
public class ErrorCodeStatusMapper {
    ...
    public HttpStatus statusOf(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case RESERVATION_NOT_FOUND, THEME_NOT_FOUND, RESERVATION_TIME_NOT_FOUND, WAITING_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case RESERVATION_TIME_IN_USE -> HttpStatus.CONFLICT;
