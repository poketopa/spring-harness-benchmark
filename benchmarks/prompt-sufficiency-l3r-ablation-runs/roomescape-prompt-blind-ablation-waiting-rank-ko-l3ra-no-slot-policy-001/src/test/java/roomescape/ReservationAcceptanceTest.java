...
class ReservationAcceptanceTest extends AcceptanceTestSupport {
    ...
    void occupiedSlotWaiting() {
        ...
        ResponseEntity<Map> waiting = createReservation(conyToken, LocalDate.of(2030, 5, 1), timeId, themeId);
    ...
    @Test
    @DisplayName("대기 순번은 신청 순서와 식별자 tie-breaker로 계산한다")
    void rankOrdering() {
        createMember("브라운", "brown@example.com");
        createMember("코니", "cony@example.com");
    ...
    @Test
    @DisplayName("내 예약 목록에서는 예약과 대기를 함께 보여 주고 대기 항목에 현재 순번을 표시한다")
    void myListResponse() {
        createMember("브라운", "brown@example.com");
        createMember("코니", "cony@example.com");
        createMember("샐리", "sally@example.com");
        ...
        createReservation(brownToken, LocalDate.of(2030, 5, 2), secondTimeId, themeId);
        createReservation(sallyToken, LocalDate.of(2030, 5, 3), secondTimeId, themeId);
        createReservation(conyToken, LocalDate.of(2030, 5, 1), firstTimeId, themeId);
        createReservation(sallyToken, LocalDate.of(2030, 5, 1), firstTimeId, themeId);
