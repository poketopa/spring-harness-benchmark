...
public class ReservationController {
    ...
    public List<ReservationResponse> findManagerReservations(LoginMember loginMember) {
        return managerReservationService.findAll(loginMember);
    }

    @GetMapping("/manager/reservations/{reservationId}")
    public ReservationResponse findManagerReservation(LoginMember loginMember, @PathVariable Long reservationId) {
        return managerReservationService.findById(loginMember, reservationId);
    }
    ...
    public ReservationResponse changeManagerReservation(
            LoginMember loginMember,
            @PathVariable Long reservationId,
            @Valid @RequestBody ReservationChangeRequest request
    ) {
    ...
    public ResponseEntity<Void> cancelManagerReservation(LoginMember loginMember, @PathVariable Long reservationId) {
