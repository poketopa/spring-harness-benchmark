...
public interface WaitingRepository extends JpaRepository<Waiting, Long> {
    ...
    @Query("""
            ...
            """)
    long countAhead(Theme theme, ReservationTime time, LocalDate date, LocalDateTime createdAt, Long id);

    @EntityGraph(attributePaths = {"theme", "time", "member"})
    List<Waiting> findAllByMemberOrderByDateAscTimeStartAtAscIdAsc(Member member);
}
