...
public class ReservationService {
    ...
    public List<ReservationResponse> findManaged(LoginMember loginMember) {
        Member manager = authenticatedMemberService.findManager(loginMember);
    ...
    public ReservationResponse findManaged(LoginMember loginMember, Long reservationId) {
        Member manager = authenticatedMemberService.findManager(loginMember);
        return ReservationResponse.from(findManagedReservation(reservationId, manager));
    }
