...
public class Member {
    ...
    @Column
    private String currentLoginTokenId;
    ...
    public void renewLoginToken(String loginTokenId) {
        validateNonBlank(loginTokenId, "로그인 토큰 식별자는 비어 있을 수 없습니다.");
        this.currentLoginTokenId = loginTokenId;
    }

    public boolean hasLoginToken(String loginTokenId) {
        return currentLoginTokenId != null && currentLoginTokenId.equals(loginTokenId);
    }
