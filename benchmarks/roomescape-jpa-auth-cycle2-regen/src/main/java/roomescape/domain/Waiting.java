...
public class Waiting {
    ...
    public Waiting(Member member, Theme theme, ReservationTime time, LocalDate date, LocalDateTime createdAt) {
        DomainValidator.requireNonNull(member, "대기 회원은 비어 있을 수 없습니다.");
        DomainValidator.requireNonNull(theme, "대기 테마는 비어 있을 수 없습니다.");
        DomainValidator.requireNonNull(time, "대기 시간은 비어 있을 수 없습니다.");
        DomainValidator.requireNonNull(date, "대기 날짜는 비어 있을 수 없습니다.");
        DomainValidator.requireNonNull(createdAt, "대기 생성 시각은 비어 있을 수 없습니다.");
        this.member = member;
        this.theme = theme;
        this.time = time;
        this.date = date;
