...
public class ReservationService {
    ...
    public ReservationResponse change(LoginMember loginMember, Long reservationId, ReservationChangeRequest request) {
        ...
        return changeManagedReservation(reservation, time, request);
    }
    ...
    ReservationResponse changeManagedReservation(
            Reservation reservation,
            ReservationTime time,
    ...
    public void cancel(LoginMember loginMember, Long reservationId) {
        ...
        cancelManagedReservation(reservation);
    }

    void cancelManagedReservation(Reservation reservation) {
