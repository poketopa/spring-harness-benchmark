...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        String sessionId = authTokenProvider.createSessionId();
        member.renewSession(sessionId);
    ...
    public LoginMember authenticate(String accessToken) {
        AuthToken authToken = authTokenProvider.extract(accessToken);
        ...
        if (!member.hasActiveSession(authToken.sessionId())) {
