...
public class ReservationController {
    ...
    public List<ReservationResponse> findManagerReservations(LoginMember loginMember) {
        return reservationService.findManagerReservations(loginMember);
    }
    ...
    public ReservationResponse changeByManager(
        ...
        return reservationService.changeByManager(loginMember, reservationId, request);
    }
    ...
    public ResponseEntity<Void> cancelByManager(LoginMember loginMember, @PathVariable Long reservationId) {
        reservationService.cancelByManager(loginMember, reservationId);
        return ResponseEntity.noContent().build();
    }
}
