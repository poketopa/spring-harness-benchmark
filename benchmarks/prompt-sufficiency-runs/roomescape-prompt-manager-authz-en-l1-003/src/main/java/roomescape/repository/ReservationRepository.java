...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @EntityGraph(attributePaths = {"member", "theme", "theme.store", "theme.store.manager", "time"})
    Optional<Reservation> findWithThemeStoreById(Long id);
    ...
    List<Reservation> findAllByThemeStoreManagerOrderByDateAscTimeStartAtAsc(Member manager);
