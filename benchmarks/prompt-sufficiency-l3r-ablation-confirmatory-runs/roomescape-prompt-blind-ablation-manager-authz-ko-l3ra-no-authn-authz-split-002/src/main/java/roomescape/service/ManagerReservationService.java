...
public class ManagerReservationService {
    ...
    @Transactional
    public void cancelManagedReservation(LoginMember loginMember, Long reservationId) {
        Member manager = findManager(loginMember);
        Reservation reservation = findManagedReservation(reservationId, manager);
    ...
    private Reservation findManagedReservation(Long reservationId, Member manager) {
        Reservation reservation = reservationRepository.findWithStoreById(reservationId)
    ...
    private void cancelReservation(Reservation reservation) {
        ...
        waitingPromotionService.promoteFirstWaiting(reservation.getTheme(), reservation.getTime(), reservation.getDate());
    }
}
