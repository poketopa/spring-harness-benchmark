...
class WaitingRepositoryIntegrationTest {
    ...
    void duplicateMemberSlotFailsByDatabaseConstraint() {
        ...
        waitingRepository.saveAndFlush(new Waiting(member, theme, time, date, LocalDateTime.of(2030, 1, 1, 10, 0)));

        Waiting duplicate = new Waiting(member, theme, time, date, LocalDateTime.of(2030, 1, 1, 10, 1));
