...
public class ReservationTimeService {
    ...
    @Transactional
    public ReservationTimeResponse create(LoginMember loginMember, ReservationTimeRequest request) {
    ...
    @Transactional
    public void delete(LoginMember loginMember, Long timeId) {
        adminAuthorizationService.validateAdmin(loginMember);
        ...
        try {
            ...
            throw new RoomescapeException(ErrorCode.RESERVATION_TIME_IN_USE, "예약이 존재하는 시간은 삭제할 수 없습니다.");
        }
    }
