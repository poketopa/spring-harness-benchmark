...
public class Member {
    ...
    public void renewLoginKey(String loginKey) {
        validateNonBlank(loginKey, "로그인 식별자는 비어 있을 수 없습니다.");
        this.currentLoginKey = loginKey;
    }

    public boolean hasCurrentLoginKey(String loginKey) {
        return currentLoginKey != null && currentLoginKey.equals(loginKey);
    }
