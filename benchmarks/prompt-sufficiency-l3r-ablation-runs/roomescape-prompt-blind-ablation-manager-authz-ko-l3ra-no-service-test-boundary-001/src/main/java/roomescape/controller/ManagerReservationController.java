...
public class ManagerReservationController {
    ...
    public ReservationResponse findManagedReservation(LoginMember loginMember, @PathVariable Long reservationId) {
        return managerReservationService.findManagedReservation(loginMember, reservationId);
    }
