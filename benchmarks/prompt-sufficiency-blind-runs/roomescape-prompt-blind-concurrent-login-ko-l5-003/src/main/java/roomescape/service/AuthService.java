...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        activeSessionRepository.findByMember(member)
                .ifPresentOrElse(
                        activeSession -> activeSession.rotate(accessToken),
    ...
    public LoginMember authenticate(String accessToken) {
        ...
        if (!activeSessionRepository.existsByMemberIdAndAccessToken(memberId, accessToken)) {
