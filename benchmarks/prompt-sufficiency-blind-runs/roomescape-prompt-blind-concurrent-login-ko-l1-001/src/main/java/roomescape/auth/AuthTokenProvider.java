...
public class AuthTokenProvider {
    ...
    public String createToken(Member member) {
        String payload = PREFIX + member.getId() + DELIMITER + member.getLoginSessionKey();
        return Base64.getUrlEncoder()
                .withoutPadding()
                .encodeToString(payload.getBytes(StandardCharsets.UTF_8));
    }

    public String createLoginSessionKey() {
    ...
    public record AuthToken(Long memberId, String loginSessionKey) {
    }
}
