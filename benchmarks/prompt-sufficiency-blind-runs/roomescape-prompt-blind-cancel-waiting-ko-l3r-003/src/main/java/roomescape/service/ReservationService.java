...
public class ReservationService {
    ...
    public void cancel(LoginMember loginMember, Long reservationId) {
        ...
        waitingRepository.findFirstByThemeAndTimeAndDateOrderByCreatedAtAscIdAsc(
                ...
                .ifPresentOrElse(
                        waiting -> cancelAndPromoteWaiting(reservation, waiting),
                        () -> reservationRepository.delete(reservation)
                );
    }

    private void cancelAndPromoteWaiting(Reservation reservation, Waiting waiting) {
        reservationRepository.delete(reservation);
        ...
        try {
            ...
            throw new RoomescapeException(ErrorCode.DUPLICATE_RESERVATION, "대기 승격 중 예약이 중복되었습니다.");
        }
    }
}
