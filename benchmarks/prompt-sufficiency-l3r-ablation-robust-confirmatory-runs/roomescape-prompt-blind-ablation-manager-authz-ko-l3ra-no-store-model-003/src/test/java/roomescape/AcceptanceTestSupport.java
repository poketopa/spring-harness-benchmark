...
abstract class AcceptanceTestSupport {
    ...
    protected ResponseEntity<List> findManagerReservations(String token) {
        return restTemplate.exchange(
    ...
    protected ResponseEntity<Map> findManagerReservation(String token, long reservationId) {
        return restTemplate.exchange(
    ...
    protected ResponseEntity<Map> changeManagerReservation(
            String token,
            long reservationId,
            LocalDate date,
            long timeId
    ...
    protected ResponseEntity<Void> cancelManagerReservation(String token, long reservationId) {
        return restTemplate.exchange(
                "/manager/reservations/" + reservationId,
                HttpMethod.DELETE,
                new HttpEntity<>(authHeaders(token)),
