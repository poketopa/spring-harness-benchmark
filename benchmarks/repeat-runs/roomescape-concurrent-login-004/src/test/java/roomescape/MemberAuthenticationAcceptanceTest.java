...
class MemberAuthenticationAcceptanceTest extends AcceptanceTestSupport {
    ...
    void newLoginInvalidatesPreviousToken() {
        ...
        assertThat(findMineWithStatus(firstToken).getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
        assertThat(findMineWithStatus(secondToken).getStatusCode()).isEqualTo(HttpStatus.OK);
    }
    ...
    private ResponseEntity<String> findMineWithStatus(String token) {
