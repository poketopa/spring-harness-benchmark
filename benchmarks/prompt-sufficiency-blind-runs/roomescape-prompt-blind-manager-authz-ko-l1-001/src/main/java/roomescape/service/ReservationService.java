...
public class ReservationService {
    ...
    public List<ReservationResponse> findVisibleReservations(LoginMember loginMember) {
        Member member = authenticatedMemberService.findMember(loginMember);
        List<Reservation> reservations = findVisibleReservations(member);
        return reservations.stream()
                .map(ReservationResponse::from)
                .toList();
    }

    private List<Reservation> findVisibleReservations(Member member) {
        if (member.isAdmin()) {
