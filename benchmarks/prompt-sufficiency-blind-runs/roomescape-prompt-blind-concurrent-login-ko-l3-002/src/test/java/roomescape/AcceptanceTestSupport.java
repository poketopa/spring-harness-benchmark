...
abstract class AcceptanceTestSupport {
    ...
    protected long createMember(String name, String email) {
        return createMember("/members", name, email);
    }

    protected long createManager(String name, String email) {
        return createMember("/admin/members/managers", name, email);
    }

    private long createMember(String path, String name, String email) {
    ...
    protected ResponseEntity<List> findManagedReservations(String token) {
        return restTemplate.exchange(
