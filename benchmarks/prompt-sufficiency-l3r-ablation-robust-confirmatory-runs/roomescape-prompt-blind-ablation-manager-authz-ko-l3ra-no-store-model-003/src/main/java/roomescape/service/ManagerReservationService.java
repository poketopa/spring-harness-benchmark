...
public class ManagerReservationService {
    ...
    public ManagerReservationService(
        ...
        this.managedStoreRepository = managedStoreRepository;
    ...
    public List<ReservationResponse> findAll(LoginMember loginMember) {
        ...
        List<Theme> managedThemes = findManagedThemes(manager);
    ...
    public ReservationResponse findById(LoginMember loginMember, Long reservationId) {
        Member manager = findManager(loginMember);
    ...
    private List<Theme> findManagedThemes(Member manager) {
        return managedStoreRepository.findAllByManager(manager)
                .stream()
                .map(ManagedStore::getTheme)
                .toList();
    }

    private Reservation findReservation(Long reservationId) {
        return reservationRepository.findWithMemberThemeTimeById(reservationId)
    ...
    private void validateManagedStore(Member manager, Reservation reservation) {
        if (!managedStoreRepository.existsByManagerAndTheme(manager, reservation.getTheme())) {
