...
public class ManagerReservationController {
    ...
    public List<ReservationResponse> findStoreReservations(LoginMember loginMember, @PathVariable Long storeId) {
        return managerReservationService.findStoreReservations(loginMember, storeId);
    }
