...
public class Reservation {
    ...
    public void changeSchedule(ReservationTime newTime, LocalDate newDate) {
        this.time = newTime;
        this.date = newDate;
    }

    public boolean hasSchedule(Theme targetTheme, ReservationTime targetTime, LocalDate targetDate) {
