...
public class ReservationController {
    ...
    public ResponseEntity<ReservationResponse> createWaiting(
        ...
        ReservationResponse response = waitingService.create(loginMember, request);
        URI location = ServletUriComponentsBuilder.fromCurrentRequest()
                .path("/{id}")
                .buildAndExpand(response.id())
                .toUri();
    ...
    public ResponseEntity<Void> cancelWaiting(LoginMember loginMember, @PathVariable Long waitingId) {
