...
import roomescape.auth.ActiveLoginSessionStore;
...
public class AuthService {
    ...
    private final ActiveLoginSessionStore activeLoginSessionStore;

    public AuthService(
            MemberRepository memberRepository,
            AuthTokenProvider authTokenProvider,
            ActiveLoginSessionStore activeLoginSessionStore
    ) {
        this.memberRepository = memberRepository;
        this.authTokenProvider = authTokenProvider;
        this.activeLoginSessionStore = activeLoginSessionStore;
    }
