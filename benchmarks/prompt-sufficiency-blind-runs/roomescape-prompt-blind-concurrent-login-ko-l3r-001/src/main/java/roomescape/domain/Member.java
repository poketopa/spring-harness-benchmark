...
public class Member {
    ...
    @Column(name = "active_session_key", length = 36)
    ...
    public void renewActiveSession(String sessionKey) {
        validateNonBlank(sessionKey, "활성 세션 키는 비어 있을 수 없습니다.");
        this.activeSessionKey = sessionKey;
    }

    public boolean hasActiveSession(String sessionKey) {
        return activeSessionKey != null && activeSessionKey.equals(sessionKey);
    }
