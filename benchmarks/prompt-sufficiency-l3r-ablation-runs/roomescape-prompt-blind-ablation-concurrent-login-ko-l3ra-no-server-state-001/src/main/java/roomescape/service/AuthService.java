...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        String loginSessionKey = UUID.randomUUID().toString();
        member.changeLoginSession(loginSessionKey);
        return new LoginResponse(authTokenProvider.createToken(member, loginSessionKey));
    }
    ...
    public LoginMember authenticate(String accessToken) {
        ...
        if (!member.hasLoginSession(payload.loginSessionKey())) {
