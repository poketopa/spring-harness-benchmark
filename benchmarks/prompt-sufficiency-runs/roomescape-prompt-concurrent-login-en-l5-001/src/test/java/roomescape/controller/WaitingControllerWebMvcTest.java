...
class WaitingControllerWebMvcTest {
    ...
    @Test
    @DisplayName("대기 생성 요청 값이 비어 있으면 잘못된 요청 응답을 반환한다")
    void invalidWaitingCreateRequestReturnsBadRequest() throws Exception {
        when(authService.authenticate("token")).thenReturn(new LoginMember(1L, "코니"));
