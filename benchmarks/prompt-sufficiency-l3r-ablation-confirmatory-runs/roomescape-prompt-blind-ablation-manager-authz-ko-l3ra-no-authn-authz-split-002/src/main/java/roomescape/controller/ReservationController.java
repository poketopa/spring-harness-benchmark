...
public class ReservationController {
    ...
    public ReservationResponse changeManagedReservation(
        ...
        return managerReservationService.changeManagedReservation(loginMember, reservationId, request);
    }
    ...
    public ResponseEntity<Void> cancelManagedReservation(LoginMember loginMember, @PathVariable Long reservationId) {
        managerReservationService.cancelManagedReservation(loginMember, reservationId);
        return ResponseEntity.noContent().build();
    }
}
